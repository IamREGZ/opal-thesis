...
import edu.cccdci.opal.databinding.FragmentOrderDeliverBinding
import edu.cccdci.opal.dataclasses.Order
import edu.cccdci.opal.firestore.FirestoreClass
import edu.cccdci.opal.layoutwrapper.WrapperLinearLayoutManager

class OrderDeliverFragment(
    private val isVendor: Boolean
) : Fragment() {

    private lateinit var binding: FragmentOrderDeliverBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentOrderDeliverBinding.inflate(inflater)
        ...
        val options = FirestoreRecyclerOptions.Builder<Order>()
            ...
            .setQuery(
                FirestoreClass().getOrderQuery(
                    this@OrderDeliverFragment, isVendor
                ),
                Order::class.java
            ).build()
        ...
        with(binding) {
            ...
            orderSalesAdapter = OrderSalesAdapter(
                this@OrderDeliverFragment, requireContext(), isVendor,
                options
            )
...
}  // end of OrderDeliverFragment class